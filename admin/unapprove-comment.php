...
if( $_GET['disid'])
{
	...
	$msg="Bình luận không được phê duyệt ";
}
// Code for restore
if($_GET['appid'])
{
...
<html lang="en">
    <head>
        ...
        <title>VN CSGO | Bình luận chờ phê duyệt</title>
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Bình luận chờ phê duyệt</h4>
...
<td>
<?php if($st=='0'):?>
    <a href="unapprove-comment.php?disid=<?php echo htmlentities($row['id']);?>" title="Từ chối bình luận này"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a> 
<?php else :?>
	<a href="unapprove-comment.php?appid=<?php echo htmlentities($row['id']);?>" title="Phê duyệt bình luận này"><i class="ion-arrow-return-right" style="color: #29b6f6;"></i></a> 
<?php endif;?>
