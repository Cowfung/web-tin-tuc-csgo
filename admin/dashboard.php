...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>VN CSGO | Bảng điều khiển</title>
...
<a href="manage-subcategories.php">
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    ...
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">Chuyên mục</p>
...
<?php include('includes/footer.php');?>
            ...
            <div class="side-bar right-bar">
                ...
                <div class="setting-list nicescroll">
                    ...
                    <div class="row m-t-20">
                        <div class="col-xs-8">
                            <h5 class="m-0">Trạng thái trực tuyến</h5>
