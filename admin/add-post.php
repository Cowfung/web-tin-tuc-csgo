...
{
echo "<script>alert('Lỗi. Vui lòng chọn định dạng ảnh jpg/jpeg/png/gif.');</script>";
}
else
{
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>VN CSGO | Thêm bài đăng</title>
...
<strong>Ồ không!</strong> <?php echo htmlentities($error);?></div>
<?php } ?>
...
<input type="text" class="form-control" id="posttitle" name="posttitle" placeholder="Nhập tên bài đăng" required>
</div>
