...
if($query)
{
$msg="Chuyên mục đã được chỉnh sửa thành công";
}
else{
...
<html lang="en">
    <head>
        ...
        <title>VN CSGO | Sửa chuyên mục</title>
                ...
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Sửa chuyên mục</h4>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <h4 class="m-t-0 header-title"><b>Sửa chuyên mục</b></h4>
                                    <hr />
