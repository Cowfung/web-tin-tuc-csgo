...
<html lang="en">
    <head>
        ...
        <meta name="description" content="VN CSGO">
        <meta name="author" content="TinTuc24H">


        <!-- App title -->
        <title>VN CSO | Trang quản trị</title>
                                ...
                                <div class="account-content">
                                    <form class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group ">
                                            <div class="col-xs-12">
                                                <input class="form-control" type="text" required="" name="username" placeholder="Tên tài khoản hoặc email" autocomplete="off">
                                            </div>
                                        </div>
