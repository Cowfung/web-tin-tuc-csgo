...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>VN CSGO | Sửa bài đăng</title>
...
<input type="text" class="form-control" id="posttitle" value="<?php echo htmlentities($row['title']);?>" name="posttitle" placeholder="Nhập tên bài đăng" required>
</div>
