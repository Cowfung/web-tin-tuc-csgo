...
if($_GET['resid'])
{
	...
	$msg="Chuyên mục đã được khôi phục";
}
...
if($_GET['action']=='perdel' && $_GET['scid'])
{
	...
	$delmsg="Chuyên mục đã bị xóa vĩnh viễn";
}
...
<html lang="en">
    <head>
        ...
        <title>VN CSGO | Quản lý chuyên mục</title>
...
<td colspan="7" align="center"><h3 style="color:red">Không có chuyên mục</h3></td>
<tr>
<?php 
} else {
...
<div class="m-b-30">
 ...
 <h4><i class="fa fa-trash-o" ></i> Thùng rác</h4>
